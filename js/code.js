...
//reference from w3schools
      ...
      function onYouTubeIframeAPIReady() {
        player = new YT.Player('player', {
          height: '390',
          width: '80%',
          videoId: 'lvAjMdqzwgI',    // this is the end of the URL code
          events: {
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("testingAjax6").innerHTML=xmlhttp.responseText;
    }
  }
xmlhttp.open("GET","ajax/text6.txt",true);
xmlhttp.send();
}
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("testingAjax7").innerHTML=xmlhttp.responseText;
    }
  }
xmlhttp.open("GET","ajax/text7.txt",true);
xmlhttp.send();
}
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("testingAjax8").innerHTML=xmlhttp.responseText;
    }
  }
xmlhttp.open("GET","ajax/text8.txt",true);
xmlhttp.send();
}
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("testingAjax9").innerHTML=xmlhttp.responseText;
    }
  }
xmlhttp.open("GET","ajax/text9.txt",true);
xmlhttp.send();
}
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("testingAjax10").innerHTML=xmlhttp.responseText;
    }
  }
xmlhttp.open("GET","ajax/text10.txt",true);
xmlhttp.send();
}
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("testingAjax11").innerHTML=xmlhttp.responseText;
    }
  }
xmlhttp.open("GET","ajax/text11.txt",true);
xmlhttp.send();
}
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("testingAjax12").innerHTML=xmlhttp.responseText;
    }
  }
xmlhttp.open("GET","ajax/text12.txt",true);
xmlhttp.send();
}
